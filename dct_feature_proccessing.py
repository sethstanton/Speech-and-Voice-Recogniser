...
# file_path = 'recordings/Ben/Ben_01/Ben_01_dct_features.csv'
...
# print(binaryFeaturesArray.shape)
...
for child in DIR_PATH.glob('*'):
    ...
    for subDir in child.glob('*'):
        ...
        if (dct_file != None) and (mfcc_file != None):
            # print(dct_file)
            # print(mfcc_file)
            ...
            filename = str(subDir).split('\\')[2] +'_idct_features.npy'
